...
public class MyModifyDeviceFrame extends MyFrame {
	...
	public static void mainForModify(Device oDevice,String userID) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					System.out.println("my modify");
					MyModifyDeviceFrame frame = new MyModifyDeviceFrame(oDevice,userID);
	 ...
	 * 
	 */
	public MyModifyDeviceFrame(Device oDevice,String userID) {
		...
		btnRegister.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (name.equals("")) {
					...
					boolean re = dController.modifyMyDevice(oDevice.getId(), device,userID);
					if (re) {
