...
class MyButtonRender3 implements TableCellRenderer {
 ...
 * 
 */
class MyButtonEditor3 extends DefaultCellEditor {
	...
	public MyButtonEditor3(JTable table) {
...
//				System.out.println("modify " + table.getSelectedRow() + " " + table.getSelectedColumn());
				...
				//打开编辑窗口
				Product oProduct = pController.findProduct(id);
				ModifyProductFrame.mainForModify(oProduct);
			}
		});
...
public class ProductManagerPanel extends JPanel {
	...
	private static ProductManagerPanel instance;
	 ...
	 */
	public static ProductManagerPanel getInstance() {
		if (instance == null) {
			instance = new ProductManagerPanel();
		}
		return instance;
	}
	...
	public void iniTable() {
		String[] columnNames = { "序号", "产品编号", "产品名称", "产品类别", "产品规格", "产品描述", "操作" };
//		String[][] cm2= {{"1","11","111"},{"2","22","222"},{"3","33","333"}};
		ProductController pController = ProductController.getInstance("Product");
		String[][] data = pController.getAll();
//		for (String[] s : data) {
...
//		}
		...
		table.getColumnModel().getColumn(6).setCellEditor(new MyButtonEditor3(table));
		table.getColumnModel().getColumn(6).setCellRenderer(new MyButtonRender3());
